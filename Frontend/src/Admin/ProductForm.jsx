...
const ProductForm = () => {
  ...
  const updatedFiles = [...images, ...files].slice(0, 5);
  setImages(updatedFiles);
  setFieldValue("images", updatedFiles);
};
                ...
                return (
                    <Form className="w-full max-w-[500px] mx-auto mt-10 sm:mt-16 md:mt-24 px-4 sm:px-0 bg-white shadow-md rounded-lg p-4 sm:p-6">
  ...
  <div className="mt-2 flex flex-wrap gap-2">
    {images.map((img, index) => {
      const url = img.preview || URL.createObjectURL(img); // preview ya new object URL
      ...
      return (
        <div key={index} className="relative w-24 h-24 border rounded overflow-hidden">
          ...
          <button
            ...
            className="absolute top-1 right-1 bg-red-500 text-white w-5 h-5 text-xs rounded-full flex items-center justify-center"
          >
            X
          </button>
        </div>
