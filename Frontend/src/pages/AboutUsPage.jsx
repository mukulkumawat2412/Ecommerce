...
const AboutUsPage = () => {
  return (
    <section className="bg-gray-50 text-gray-800 pt-32 md:pt-36">
      {/* Hero Section */}
      ...
      <div className="bg-white py-16 sm:py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 md:gap-10">
            {[
              { name: "Mukul Kumawat", role: "Founder & CEO", img: "https://randomuser.me/api/portraits/men/32.jpg" },
              { name: "Aarav Sharma", role: "Marketing Head", img: "https://randomuser.me/api/portraits/men/41.jpg" },
              { name: "Priya Singh", role: "Design Lead", img: "https://randomuser.me/api/portraits/women/44.jpg" },
            ].map((member) => (
              <div key={member.name} className="bg-gray-50 p-6 rounded-xl shadow hover:shadow-xl transition duration-300">
                <img src={member.img} alt={member.name} className="w-28 h-28 sm:w-32 sm:h-32 mx-auto rounded-full object-cover mb-4"/>
                <h4 className="text-lg sm:text-xl font-semibold text-gray-900">{member.name}</h4>
