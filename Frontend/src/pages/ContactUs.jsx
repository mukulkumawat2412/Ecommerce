    ...
    <section className="max-w-6xl mx-auto p-6 md:p-12">
      ...
      >
        ...
        <div className="lg:col-span-1 bg-white/60 backdrop-blur-md p-6 rounded-2xl shadow-md border border-gray-100">
          ...
          <p className="text-sm text-gray-600 mb-6">Have a question, business inquiry or feedback? Fill the form — we usually reply within 1 business day.</p>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600">123 Commerce St, Suite 400<br />Mumbai, India</p>
              </div>
            </div>
        ...
        <div className="lg:col-span-2 bg-white p-6 rounded-2xl shadow-md border border-gray-100">
          ...
          <p className="text-sm text-gray-600 mb-6">Tell us a bit about your request — the more detail, the better we can help.</p>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-2 rounded-lg border focus:ring-2 focus:ring-indigo-200 outline-none ${errors.name ? "border-red-300" : "border-gray-200"}`}
                />
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-2 rounded-lg border focus:ring-2 focus:ring-indigo-200 outline-none border-gray-200"
                defaultValue="Pending"  // Default enum value
            ...
            <div className="flex items-center gap-4">
              {/* <div>
                ...
                <input type="file" {...register("attachment")} className="text-xs" aria-label="attachment" />
              </div> */}
            ...
            <div className="pt-2 text-xs text-gray-400">By submitting you agree to our <a href="/privacy" className="underline">privacy policy</a>.</div>
          </form>
        </div>
      </motion.div>
    </section>
