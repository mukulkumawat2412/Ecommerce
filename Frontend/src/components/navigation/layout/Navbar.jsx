          ...
          {role === "admin" && (
            <>
              ...
              <Link to="/create-coupon">
                <li className="hover:text-purple-300 cursor-pointer">Coupon</li>
              </Link>
            </>
          )}
        ...
        <div ref={dropdownRef} className="relative">
          {!isAuthenticated ? (
            ...
            <div>
              ...
              {isDropdownOpen && (
                <div className="absolute right-0 top-full mt-2 w-44 bg-white text-black border rounded-md shadow-md z-50 max-md:right-1/2 max-md:translate-x-1/2 max-md:w-52">
                  <Link
                    to="/profile"
              ...
              {isAuthenticated && (
                <div className="flex gap-8 py-3 border-b border-gray-800">
                  ...
                  >
                    ...
                    <span>Cart</span>
                    {cartItems.length > 0 && (
                      <span className="absolute -top-1 left-3 bg-red-500 text-white text-xs font-bold px-1.5 py-0.5 rounded-full">
                        {cartItems.length}
                      </span>
                    )}
                  </Link>
                  ...
                  >
                    ...
                    <span>Wishlist</span>
                    {wishlistItems.length > 0 && (
                      <span className="absolute -top-1 left-3 bg-red-500 text-white text-xs px-1.5 rounded-full">
                        {wishlistItems.length}
                      </span>
                    )}
                  </Link>
