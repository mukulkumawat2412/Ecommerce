...
import { Login ,Logout,RefreshAccessToken,Register,Profile, UpdateProfile, ProfileChangePassword,GetAllUsers, Unlockeduser} from "../controllers/user.controller.js";
...
router.route("/unlock-user/:id").patch(verifyToken,authorizeRoles(["admin"]),Unlockeduser)
